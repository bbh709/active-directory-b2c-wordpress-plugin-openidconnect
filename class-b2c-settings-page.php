...
class B2C_Settings_Page {
	...
	public function page_init() {
		...
		/*
		add_settings_field(
			'b2c_aad_tenant_id', // ID
			'Tenant Id', // Title
			array( $this, 'b2c_aad_tenant_id_callback' ), // Callback
			'b2c-settings-page', // Page
			'service_config_section' // Section
		);*/
		...
		add_settings_field(
			'b2c_signup_policy_id', // ID
			'Sign-up Policy for Users', // Title
			array( $this, 'b2c_signup_policy_id_callback' ), // Callback
			'b2c-settings-page', // Page
			'service_config_section' // Section
		);
        ...
        add_settings_field(
			'b2c_create_users', // ID
			'Create user if not exists', // Title
			array( $this, 'b2c_create_users_callback' ), // Callback
			'b2c-settings-page', // Page
			'service_config_section' // Section
		);
	...
	public function sanitize( $input ) {
		...
		/*
		if( isset( $input['b2c_aad_tenant_id'] ) )
			$new_input['b2c_aad_tenant_id'] = sanitize_text_field(strtolower( $input['b2c_aad_tenant_id'] ));
		  */
		...
		if ( isset( $input['b2c_signup_policy_id'] ) ) {
			$new_input['b2c_signup_policy_id'] = sanitize_text_field( strtolower( $input['b2c_signup_policy_id'] ) );
		}
        ...
        $new_input['b2c_create_users'] = $input['b2c_create_users'];
	...
	public function b2c_aad_tenant_name_callback() {
		printf(
			'<input type="text" id="b2c_aad_tenant_name" size="70" name="b2c_config_elements[b2c_aad_tenant_name]" value="%s" />'
	...
	public function b2c_aad_tenant_domain_callback() {
		printf(
			'<input type="text" id="b2c_aad_tenant_domain" size="70" name="b2c_config_elements[b2c_aad_tenant_domain]" value="%s" />'
		 ...
		 */
	/*
	 public function b2c_aad_tenant_id_callback()
	{
		printf(
			'<input type="text" id="b2c_aad_tenant_id" name="b2c_config_elements[b2c_aad_tenant_id]" value="%s" />'
			.  '<br/><i>ex: aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee</i>',
			isset( $this->options['b2c_aad_tenant_id'] ) ? esc_attr( $this->options['b2c_aad_tenant_id']) : ''
		);
	}
	*/
	...
	public function b2c_client_id_callback() {
		printf(
			'<input type="text" id="b2c_client_id" size="70" name="b2c_config_elements[b2c_client_id]" value="%s" />'
			. '<br/><i>The ID of the application registered in Azure B2C</i>',
	...
	public function b2c_admin_policy_id_callback() {
		printf(
			'<input type="text" id="b2c_admin_policy_id" size="70" name="b2c_config_elements[b2c_admin_policy_id]" value="%s" />'
	...
	public function b2c_subscriber_policy_id_callback() {
		printf(
			'<input type="text" id="b2c_subscriber_policy_id" size="70" name="b2c_config_elements[b2c_subscriber_policy_id]" value="%s" />'
	  ...
	  * Get the settings option array and print one of its values
	  */
	public function b2c_signup_policy_id_callback() {
		printf(
			'<input type="text" id="b2c_signup_policy_id" size="70" name="b2c_config_elements[b2c_signup_policy_id]" value="%s" />'
			. '<br/><i>Specify a Sign-up Policy if you allow WordPress users to create their own subscriber accounts separatly from signin in.</i>',
			isset( $this->options['b2c_signup_policy_id'] ) ? esc_attr( $this->options['b2c_signup_policy_id'] ) : ''
		);
	}
	...
	public function b2c_edit_profile_policy_id_callback() {
		printf(
			'<input type="text" id="b2c_edit_profile_policy_id" size="70" name="b2c_config_elements[b2c_edit_profile_policy_id]" value="%s" />'
			. '<br/><i>Specify the policy used to allow users to edit their profile information.</i>',
	...
	public function b2c_password_reset_policy_id_callback() {
		printf(
			'<input type="text" id="b2c_password_reset_policy_id" size="70" name="b2c_config_elements[b2c_password_reset_policy_id]" value="%s" />'
	 ...
	 * Get the settings option array and print one of its values
	 */
	public function b2c_create_users_callback() {
		if ( empty( $this->options['b2c_create_users'] ) ) {
			$this->options['b2c_create_users'] = 0;
		}

		$current_value = $this->options['b2c_create_users'];
		echo '<input type="checkbox" id="b2c_create_users" name="b2c_config_elements[b2c_create_users]" value="1" class="code" ' . checked( 1, $current_value, false ) . ' />';
	}
}
